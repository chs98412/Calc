...
WebUI.initWidgets = function() {
        ...
        WebUI.app = new WebUI.Row({
            children: [
                            ...
                            new WebUI.Container({
                                ...
                                children: [ new WebUI.Text("WebUI Calculator","blue"),]}),
                            ...
                            new WebUI.Container({
                                ...
                                new WebUI.Container({
                                    desired_size: {width: 450, height: 40}, 
                                ...
                                new WebUI.Text(displayValue,"black")]})
                ...
                new WebUI.Column({ children: [
                    new WebUI.CalcButton("1", {width: 30, height: 30}),
                    new WebUI.CalcButton("2", {width: 30, height: 30}),
                    new WebUI.CalcButton("3", {width: 30, height: 30}),
                    new WebUI.CalcButton("4", {width: 30, height: 30}),
                    new WebUI.CalcButton("5", {width: 30, height: 30}),
                    new WebUI.CalcButton("6", {width: 30, height: 30}),
                    new WebUI.CalcButton("7", {width: 30, height: 30}),
                    new WebUI.CalcButton("8", {width: 30, height: 30}),
                    new WebUI.CalcButton("9", {width: 30, height: 30}),
                    new WebUI.CalcButton("0", {width: 30, height: 30}),
                ]
            })]}),
            ...
            new WebUI.Container({
                ...
                children: [
            new WebUI.Column({ children: [
                new WebUI.CalcButton("+", {width: 30, height: 30}),
                new WebUI.CalcButton("-", {width: 30, height: 30}),
                new WebUI.CalcButton("*", {width: 30, height: 30}),
                new WebUI.CalcButton("/", {width: 30, height: 30}),
                new WebUI.CalcButton("%", {width: 30, height: 30}),
    ...
    new WebUI.Container({
        ...
        children: [
    new WebUI.Column({ children: [
        new WebUI.CalcButton("i", {width: 30, height: 30}),
        new WebUI.CalcButton("e", {width: 30, height: 30}),
        new WebUI.CalcButton("pi", {width: 30, height: 30}),
        new WebUI.CalcButton("w", {width: 30, height: 30}),
        new WebUI.CalcButton("x", {width: 30, height: 30}),
        new WebUI.CalcButton("y", {width: 30, height: 30}),
        new WebUI.CalcButton("z", {width: 30, height: 30}),
        new WebUI.CalcButton("f", {width: 30, height: 30}),
        new WebUI.CalcButton("g", {width: 30, height: 30}),
        new WebUI.CalcButton("=", {width: 30, height: 30}),
    ]
})]}),
...
new WebUI.Container({
    ...
    children: [
new WebUI.Column({ children: [
    new WebUI.CalcButton("exp", {width: 30, height: 30}),
    new WebUI.CalcButton("log", {width: 30, height: 30}),
    new WebUI.CalcButton("sqrt", {width: 30, height: 30}),
    new WebUI.CalcButton("sin", {width: 30, height: 30}),
    new WebUI.CalcButton("cos", {width: 30, height: 30}),
    new WebUI.CalcButton("tan", {width: 30, height: 30}),
    new WebUI.CalcButton("cross", {width: 30, height: 30}),
    new WebUI.CalcButton("det", {width: 30, height: 30}),
    new WebUI.CalcButton("CL", {width: 30, height: 30}),
    new WebUI.CalcButton("EV", {width: 30, height: 30}),
]
})]}),
